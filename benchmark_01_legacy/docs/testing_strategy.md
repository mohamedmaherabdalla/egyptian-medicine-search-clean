...
- `benchmark_01_legacy/artifacts/01_current_app/case_results.csv.gz`: one losslessly archived row for every evaluated test case, including `input`, `expected`, `first_rank`, Hit@k flags, top-1 fields, top-5 bases, and safety flags.
...
- `benchmark_01_legacy/artifacts/01_current_app/case_results.csv.gz`
...
- `benchmark_01_legacy/artifacts/02_external_fast/case_results.csv.gz`
